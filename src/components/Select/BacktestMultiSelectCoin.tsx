...
export class BacktestMultiSelectCoin extends React.PureComponent {
  ...
  public state: IMultiSelectExampleState = {
    ...
    createdItems: [],
    fill: false,
    coins: this.context.globalState.backtest.portfolio,
  ...
  private selectCoins(coinsToSelect: PortfolioCoin[]) {
    ...
    this.context.dispatch({ type: "ADD_BACKTEST_COIN", payload: nextCoins });
  }
